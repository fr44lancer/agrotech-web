...
const translations = {
  en: {
    ...
    growingSub1: 'At AGROTECH, we believe in the power of collaboration. Our partnerships with leading organizations, research institutions, and distributors enable us to deliver innovative solutions and expand our global reach.',
    growingSub2: 'Together, we\'re shaping the future of sustainable agriculture and making a positive impact on communities worldwide.',
  ...
  ru: {
    ...
    growingSub1: 'В AGROTECH мы верим в силу сотрудничества. Наше партнерство с ведущими организациями, исследовательскими институтами и дистрибьюторами позволяет нам предлагать инновационные решения и расширять наше глобальное присутствие.',
    growingSub2: 'Вместе мы формируем будущее устойчивого сельского хозяйства и оказываем положительное влияние на сообщества по всему миру.',
  ...
  hy: {
    ...
    growingSub1: 'AGROTECH-ում մենք հավատում ենք համագործակցության ուժին: Առաջատար կազմակերպությունների, հետազոտական ինստիտուտների և դիստրիբյուտորների հետ մեր գործընկերությունը թույլ է տալիս մեզ տրամադրել նորարարական լուծումներ:',
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {partners.length === 0 ? (
              ...
              partners.map((partner) => (
                <div key={partner.id} className="bg-white p-8 rounded-lg shadow-sm border border-gray-100 flex flex-col items-center text-center hover:shadow-md transition-shadow">
                  ...
                  {partner.websiteUrl && (
                    <a href={partner.websiteUrl} target="_blank" rel="noopener noreferrer" className="text-teal-600 font-semibold hover:text-teal-700 w-full rounded border border-teal-600 py-2 transition hover:bg-teal-50">
                      {t.visitWebsite}
                    </a>
                  )}
                </div>
