...
const translations = {
  ...
  ru: {
    back: 'Назад к открытым вакансиям',
    applyTitle: 'Подать заявку на эту вакансию',
    department: 'Отдел',
    location: 'Местоположение',
    type: 'Тип занятости',
  },
  hy: {
    back: 'Վերադառնալ բաց հաստիքներին',
    applyTitle: 'Դիմել այս հաստիքի համար',
    department: 'Բաժին',
    location: 'Գտնվելու վայր',
    type: 'Աշխատանքի տեսակ',
  },
}
  ...
  return (
    <div className="w-full bg-gray-50 min-h-screen py-16">
      <div className="container mx-auto px-6 max-w-5xl">
        ...
        <Link
          href={`/${locale}/careers`}
          className="text-teal-600 hover:text-teal-700 font-semibold mb-8 inline-flex items-center gap-1"
        >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mt-4">
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 sticky top-8">
              ...
              <ApplyForm careerId={career.id} locale={locale} />
            </div>
          </div>
