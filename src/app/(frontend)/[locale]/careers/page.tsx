...
const translations = {
  en: {
    ...
    whySub: 'Join a team of passionate professionals dedicated to transforming agriculture through innovation and sustainability.',
  },
  ru: {
    ...
    whySub: 'Присоединяйтесь к команде увлеченных профессионалов, стремящихся преобразовать сельское хозяйство с помощью инноваций.',
  },
  hy: {
    ...
    whySub: 'Միացեք նվիրված մասնագետների թիմին, որը նպատակ ունի վերափոխել գյուղատնտեսությունը նորարարության միջոցով:',
  },
}
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {careers.length === 0 ? (
              ...
              careers.map((career) => {
                return (
                  <div key={career.id} className="bg-white rounded-lg shadow-sm border border-gray-100 p-6 hover:shadow-md transition-shadow">
                    ...
                    <Link href={`/${locale}/careers/${career.slug}`} className="inline-block bg-teal-600 text-white px-6 py-2 rounded font-semibold hover:bg-teal-700 transition">
                      {t.applyNow}
                    </Link>
                  </div>
                )
