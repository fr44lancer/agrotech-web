...
export const FinancialReportingBlockComponent: React.FC<FinancialReportingBlockProps> = ({
  heading,
  subheading,
  annualReports,
  quarterlyResults,
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          {annualReports && annualReports.length > 0 && (
            <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-100">
              <h3 className="text-xl font-bold text-gray-800 mb-4">Annual Reports</h3>
          ...
          {quarterlyResults && quarterlyResults.length > 0 && (
            <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-100">
              <h3 className="text-xl font-bold text-gray-800 mb-4">Quarterly Results</h3>
              <div className="space-y-3">
